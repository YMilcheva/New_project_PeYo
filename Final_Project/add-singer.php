<?php
	...
	session_start();
	$siteTitle = 'Music is your passion ' . $_SESSION['user_name_first'] . '! Add new singer!';
...
<div id="song-content">
	<div id="text">
		<h2>Thank you for you being here, <?php echo $_SESSION['user_name_first'] ?>! Add new singer</h2>
		<?php 
		...
		<div id="login-row" class="row justify-content-center align-items-center">
                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="singer_name" class="text-secondary">Singer name:</label><br>
                                <input type="text" name="singer_name" id="singer_name" class="form-control">
                            </div>                            
                            <div class="form-group">                                
            ...
            <?php
            	if(isset($_POST['submit'])){ 
					if (strlen(trim($_POST['singer_name'])) < 1){
						 echo '<h3 class="text-center text-secondary">Please fill Singer name field</h3>';   						 
					} else {
						$insert_query = "INSERT INTO singers (singer_name, singer_approved) VALUES ('" . $_POST['singer_name'] . "', 0)";
						$result = mysqli_query($conn, $insert_query); 
						if($result){
							$_SESSION['alert_message'] = '<h3 class="text-center text-secondary text-success">Singer is added. Please give us some time to approve your insertion</h3>';
